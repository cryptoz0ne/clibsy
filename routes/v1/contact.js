 ...
 *
 * @apiSuccess (200) {Array} contacts Array of contacts
 *
 ...
 * @apiSuccess (200) {Object} connection.user    Full user object (optional with "u" parameter)
 ...
 * @apiSuccess (200) {Array}  addresses    Array of addresses using the following "address" object layout
...
/**
 * @api {GET} /contacts/:id/phones [GET] /contacts/:id/phones
 * @apiName GetContactsIdPhones
 * @apiGroup Contact
 *
 * @apiVersion 1.0.0
 *
 * @apiPermission none
 *
 * @apiDescription Retrieves an array of phones for contact (:id) for current user.
 *
 * @apiHeader {String} authorization Authorization token
 *
 * @apiSuccess (200) {Array}  phones      Array of phone numbers using the following "phone" object layout
...
/**
 * @api {GET} /contacts/:id/addresses [GET] /contacts/:id/addresses
 * @apiName GetContactsIdAddresses
 * @apiGroup Contact
 *
 * @apiVersion 1.0.0
 *
 * @apiPermission none
 *
 * @apiDescription Retrieves an array of addresses for contact (:id) for current user.
 *
 * @apiHeader {String} authorization Authorization token
 *
 * @apiSuccess (200) {Array}  addresses    Array of addresses using the following "address" object layout
 ...
 * @apiParam (Body) {String} family_name
 * @apiParam (Body) {String} email
 * @apiParam (Body) {String} website
 * @apiParam (Body) {String} note
 * @apiParam (Body) {Number} user_id
 * @apiParam (Body) {Number} company_id
 *
 * @apiSuccess (200) {Number} contact_id  ID of the contact
 * @apiSuccess (200) {String} given_name  Given name (first name)
 * @apiSuccess (200) {String} family_name Family name (last name)
 ...
 * @apiSuccess (201) {String} email       Email address of contact
 * @apiSuccess (201) {String} website     Website associated with contact
 * @apiSuccess (201) {String} note        Notes associated with contact
 * @apiSuccess (201) {Object} connection
 * @apiSuccess (201) {Number} connection.user_id ID of user with account
 * @apiSuccess (201) {Object} connection.user    Full user object (optional with "u" parameter)
 * @apiSuccess (201) {Object} company
 * @apiSuccess (201) {Number} company.company_id ID of the company
 * @apiSuccess (201) {String} company.name       Name of the company
 * @apiSuccess (201) {String} company.logo_image URL string pointing to the company logo image
 * @apiSuccess (201) {String} company.email      Email address of company
 * @apiSuccess (201) {String} company.website    Website URL of the company
 * @apiSuccess (201) {String} company.desc       Description of the company
 *
 * @apiSuccessExample {json} Success-Response:
 *  HTTP/1.1 201 OK
 *  {
