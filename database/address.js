        ...
        address_1: { // street
            ...
            validate: {
                len: {
                    ...
                    msg: 'Address line 1 must be no more than ' + ADDRESS_LINE_MAX_LENGTH + ' characters in length'
                }
            }
        },
        address_2: {
        ...
        locality: { // city
            ...
            validate: {
                len: {
                    ...
                    msg: 'Locality (city) must be no more than ' + ADDRESS_LOCALITY_MAX_LENGTH + ' characters in length'
                }
            }
        },
        ...
        region: { // state
            ...
            validate: {
                len: {
                    ...
                    msg: 'Region (state) must be no more than ' + ADDRESS_REGION_MAX_LENGTH + ' characters in length'
                }
            }
        },
        ...
        postalCode: {
            ...
            validate: {
                len: {
                    ...
                    msg: 'Postal code must be no more than ' + ADDRESS_POSTALCODE_MAX_LENGTH + ' characters in length'
                }
            }
        }
    }, {
